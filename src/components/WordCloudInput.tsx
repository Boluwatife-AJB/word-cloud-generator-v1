  ...
  return (
    <div className="flex-1 sm:w-1/2 w-full ">
      ...
      <textarea
        ...
        className="w-full bg-[#CBE4DE] mt-2 rounded-xl focus:border-2 focus:outline-none font-lato-sans px-4 py-5 border text-[#2C3333] border-[#2C3333] h-[150px] lg:h-[300px] "
        value={text}
        onChange={(e) => setText(e.target.value)}
      ></textarea>

      <div className="flex-col lg:flex-row gap-2 lg:space-y-0 flex mt-4 items-center justify-center lg:gap-[2rem]">
        <Button
        ...
        <Button
          className="bg-[#ff6347] hover:bg-[#ff63473d] text-white"
          onClick={resetWordCloud}
        >
          Reset Word Cloud
        </Button>
      </div>
